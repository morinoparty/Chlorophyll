...
const ROLE_RULES = {
    bg: "ページの地色（白いパネルを浮かせる沈んだ背景）",
    "bg.subtle": "bg より淡い背景色",
    "surface.subtle": "白いパネルの上にごく薄く色を差す面（表の見出し行・縞・カードの hover）",
    surface: "カード等の表面色",
    "surface.hover": "surface のホバー色",
    "surface.active": "surface のアクティブ色",
    "border.subtle": "brand 用の最も控えめなボーダー",
    "border.muted": "brand 用の控えめなボーダー",
    border: "brand 用ボーダー色（非インタラクティブ要素）",
    "border.interactive": "brand 用のインタラクティブ要素のボーダー",
    "border.emphasized": "brand 用の強調ボーダー",
    fg: "標準テキスト色",
    "fg.muted": "控えめなテキスト色",
    "fg.subtle": "さらに控えめなテキスト色",
    solid: "アクセントの塗り色（ボタン等）",
    "solid.emphasized": "solid の強調色（hover 等）",
    "solid.active": "solid の押下色（active）",
...
const GLOBAL_RULES = {
    ...
    "bg.panel.hover": "白いパネル状コントロールのホバー背景",
    "bg.disabled": "disabled コントロールの背景色",
    "bg.error": "エラー状態のアラート/バナーの地色（fg.error と組み合わせる）",
    "bg.warning": "警告状態のアラート/バナーの地色（fg.warning と組み合わせる）",
    "bg.success": "成功状態のアラート/バナーの地色（fg.success と組み合わせる）",
    "bg.info": "情報状態のアラート/バナーの地色（fg.info と組み合わせる）",
    fg: "標準テキスト色",
    "fg.muted": "控えめなテキスト色",
    "fg.subtle": "さらに控えめなテキスト色",
    "fg.inverted": "bg.inverted 上の文字色",
    "fg.placeholder": "入力欄・Select のプレースホルダー文字色",
